...
const appCss = "/assets/styles-YbE8dYdW.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Drone-Enabled Illegal Dumping Detection & Rapid Removal — Council Proposal" },
      { name: "description", content: "Interactive council briefing: drone surveillance, GPS mapping, and rapid removal of illegally dumped waste in bushland and reserves." },
      { name: "author", content: "Greenback Recovery PTY LTD" },
      { property: "og:title", content: "Drone-Enabled Illegal Dumping Detection & Rapid Removal" },
      { property: "og:description", content: "An interactive proposal presentation for local councils." },
...
const $$splitComponentImporter = () => import("./index-xvaq2-3Y.js");
